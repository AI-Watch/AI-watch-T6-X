...
//  $subsection["chart"]["10006"]["data"] = $site_abs_path . $data_folder . "services";
  ...
  $subsection["chart"]["10006"]["graph"] = '<perspective-viewer view="sunburst" row-pivots=\'["geoextent"]\' sort=\'[["id", "asc"]]\' columns=\'["id", "geocoverage"]\' aggregates=\'{"id": "distinct count"}\' id="chart-10006"></perspective-viewer>';
...
//  $subsection["chart"]["10008"]["data"] = $site_abs_path . $data_folder . "services";
  ...
  $subsection["chart"]["10008"]["graph"] = '<perspective-viewer view="sunburst" row-pivots=\'["uptake", "geocoverage"]\' sort=\'[["id", "asc"]]\' columns=\'["id", "name"]\' aggregates=\'{"id": "distinct count"}\' id="chart-10008"></perspective-viewer>';
